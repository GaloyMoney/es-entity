...
///
/// ListDirection enum is used to specify order when listing entities from the database using [crate::EsRepo]
...
/// generated by [crate::EsRepo]. It is generated automatically for all fields which have `list_by` option. It encapsulates two fields,
/// first is `by` to specify the field name, second is `direction` which takes [crate::ListDirection]
///
/// # Example
///
/// ```ignore
...
/// A field's cursor is generated by [crate::EsRepo] if it has `list_by` option.
///
/// # Examples
///
/// ```ignore
